...
image_name = "checkerboard_002"
image = cv2.imread(f"data/debug_data/calibration/{image_name}.png")
...
T_table_to_camera = compute_table_to_camera(image, pattern_size, square_size, mtx, dist, report_dir, error_threshold)
