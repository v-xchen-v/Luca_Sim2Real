...
class_names = [
    ...
    "rectanglar dark yellow box", 
    # "toy hammer", 
    "Rubik's cube white cube",
    "juice milk with a cap",
    # "coke can"
    ]
...
class_mapping_dict = {
    ...
    "rectanglar dark yellow box": "realsense_box_1024",
    # "toy hammer": "hammer_1102",
    "Rubik's cube white cube": "cube_055_1103",
    "juice milk with a cap": "bottle_coconut_1105",
...
if __name__ == "__main__":
    ...
    import cv2
    # realsense camera can not be used by VideoCapture(0)
